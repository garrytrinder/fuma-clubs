...
import { updatePlayer, State } from "@/app/lib/actions"
            ...
            <div className="p-3 bg-body-tertiary rounded-3">
                <div className="mb-3">
                    <div className="text-center">
                        <Image src={image} alt={player.discordUsername} width={100} height={100} className="rounded-circle text-center" />
                    </div>
                </div>
                <Form onSubmit={handleSubmit} action={formAction}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="text" className="form-control" name="team" id="team" aria-describedby="teamHelp" value={team?.name || "Free player"} disabled />
                        <input type="hidden" className="form-control" name="teamId" id="teamId" value={team?.id || "0"} />
