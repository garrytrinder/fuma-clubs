export const HOWTOUSE = [
  "Select the position, height and weight to find the base stats for your pro.",
...
export const HOWTOUSE_FR = [
  "Sélectionnez la position, la taille et le poids pour trouver les statistiques de base de votre pro.",
...
export const HOWTOUSE_IT = [
  "Seleziona la posizione, l'altezza e il peso per trovare le statistiche di base per il tuo pro.",
...
export const HOWTOUSE_ES = [
  "Seleccione la posición, la altura y el peso para encontrar las estadísticas base de su pro.",
