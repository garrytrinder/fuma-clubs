    ...
    <section className="col-xxl-8 mx-auto p-4 my-3 rounded-3 border shadow-lg">
      <div className="row flex-lg-row-reverse align-items-center g-5">
        <div className="col-lg-12">
          ...
          <h2 className="display-5 fw-bold text-primary lh-1 mb-3">Join the Discord</h2>
    ...
    <section className="col-xxl-8 mx-auto p-4 rounded-3 border shadow-lg">
      <div className="row flex-lg-row-reverse align-items-center g-5">
        <div className="col-lg-12">
          ...
          <h2 className="display-5 fw-bold text-primary lh-1 mb-3">Create your player</h2>
          <p className="lead">To take part in the championship, your player must respect <Link href="/rules">the rules</Link>.</p>
        </div>
      </div>
    </section>
    <div className="divider"></div>
